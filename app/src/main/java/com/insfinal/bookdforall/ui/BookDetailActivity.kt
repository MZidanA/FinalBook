...
import com.insfinal.booksforall.databinding.ActivityBookDetailBinding // Pastikan import ini benar
...
class BookDetailActivity : AppCompatActivity() {
    ...
    private fun displayBookDetails(book: Book) {
        Glide.with(this)
            ...
            .placeholder(com.insfinal.booksforall.R.drawable.placeholder_book_cover)
            .error(com.insfinal.booksforall.R.drawable.placeholder_book_cover)
